...
<head>
    ...
    <meta name="description" content="E-Learning PKBM ZamZam">
    <meta name="author" content="e-learning, smk, spm, sd, smp, pkbmzamzam, lms">

    <meta name="docsearch:language" content="en">
    <meta name="docsearch:version" content="4.5">

    <title>E-Learning PKBM ZamZam</title>
...
<body class="text-center">
    ...
    <form class="form-signin" action="<?= $homeurl ?>/mobile_login.php" method="POST" name="login" style="z-index: 2;">
        ...
        <p class="mt-3" style="margin-bottom: 0;">
            <a href="registrasi.php">Belum punya akun ? Daftar disini yaaa.</a>
        </p>
